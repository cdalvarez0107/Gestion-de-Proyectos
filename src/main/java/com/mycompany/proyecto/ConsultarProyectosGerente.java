 ...
 * @author carlos
 */
public class ConsultarProyectosGerente extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarProyectosGerente
     */
    public ConsultarProyectosGerente() {
        initComponents();
        llenarJTable();
    }
    ...
    private void llenarJTable(){
        ...
        DefaultTableModel t = new DefaultTableModel(new String[]{"ID","Nombre del Proyecto","Fecha de Inicio","Fecha de Finalizacion","Departamento"},equipoSeleccionado.getProyectos().size());
        jTable1.setModel(t);
